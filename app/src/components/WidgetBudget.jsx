...
const WidgetBudget = ({ budgetLines, onLineClick }) => {
  ...
  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      {/* SECTION RÉSUMÉ */}
      <div
        style={{ display: "flex", justifyContent: "space-around", marginBottom: 15, fontSize: 12 }}
      >
        ...
        <div style={{ textAlign: "center" }}>
          <b style={{ display: "block", fontSize: 14, color: "var(--pink-dark)" }}>
        ...
        {sortedLines.map((line) => (
          <div key={line.lineId} className="row" onClick={() => onLineClick(line)}>
            ...
            <div className="rowS">
              ...
              {line.paid > 0 && (
                <span style={{ color: "var(--pink-dark)", marginLeft: 5 }}>(-{line.paid})</span>
              )}
            </div>
          </div>
        ))}
